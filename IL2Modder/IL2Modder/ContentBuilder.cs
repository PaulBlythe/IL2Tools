...
namespace IL2Modder
{
    ...
    class ContentBuilder : IDisposable
    {
        ...
        void CreateBuildProject()
        {
            ...
            projectRootElement.AddImport(Application.StartupPath+"/MSbuild/Microsoft.Xna.GameStudio.ContentPipeline.targets");
        ...
        void CreateTempDirectory()
        {
            ...
            buildDirectory = Application.StartupPath + "/Content";// Path.Combine(processDirectory, directorySalt.ToString());
