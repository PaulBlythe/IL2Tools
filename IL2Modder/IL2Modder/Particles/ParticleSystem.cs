...
namespace IL2Modder.Particles
{
    public class ParticleSystem 
    {
        ...
        public ParticleSystem(ParticleSettings settings, Effect effect, Texture2D texture)
        {
            ...
            vertexBuffer = new DynamicVertexBuffer(Form1.graphics, ParticleVertex.VertexDeclaration,
            ...
            indexBuffer = new IndexBuffer(Form1.graphics, typeof(ushort), indices.Length, BufferUsage.WriteOnly);
        ...
        public void Draw()
        {
            GraphicsDevice device = Form1.graphics;
